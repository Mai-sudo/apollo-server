...
## Написання коду 
Для обробки запитів GraphQL нам потрібна схема, яка визначає тип Запиту, і нам потрібен корінь API з функцією, яка називається “резольвер” для кожної кінцевої точки API. Для API, який просто повертає “Привіт світ!”, Ми можемо помістити цей код у файл з іменем ##server.js:
